# -*- coding: utf-8 -*-
"""Created on Sat Jan  2 19:10:56 2016
...
#This is a fix band_index = 2 
'''
flow to calculate transport data
only for band indices n =2 implementation
'''
def cal_transport(t_1, t_2):
  #print('link start!')
  #job_dir = os.getcwd()
  #print('find hopping parameters here: %s' % job_dir)
  #t_1 = np.loadtxt(job_dir + '/t1.dat')
  print(t_1)
  #t_2 = np.loadtxt(job_dir + '/t2.dat')
  ...
  ex_band_3, ex_velocity_3 = Exciton().cal_band_and_velocity(h_terms, v_terms, t_3)
  print(ex_band_1)
  print(ex_band_2)
  print(ex_band_3)
